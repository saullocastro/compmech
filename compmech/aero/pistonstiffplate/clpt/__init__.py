r"""
================================================
CLPT (:mod:`compmech.aero.pistonstiffplate.clpt`)
================================================

.. currentmodule:: compmech.aero.pistonstiffplate.clpt

The ``compmech.aero.pistonstiffplate.clpt`` module contains all the methods
