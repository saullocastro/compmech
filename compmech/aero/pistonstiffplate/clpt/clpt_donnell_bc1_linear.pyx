            ...
            for k1 in range(1, m1+1):
                for l1 in range(1, n1+1):
                    ...
                    if k1 != i1 and l1 != j1:
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+2
                        k0v[c] += 0.5*(pi*pi)*j1*l1*((-1)**(j1 + l1) - 1)*(3*B16*(b*b)*(i1*i1) + B26*(a*a)*(l1*l1))/(a*(b*b)*(j1 - l1)*(j1 + l1))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+2
...
def fk0sb(double ys, double bb, double a, double b, int m1, int n1,
            ...
            for k1 in range(1, m1+1):
                for l1 in range(1, n1+1):
                    ...
                    if k1 != i1 and l1 != j1:
                        ...
                        k0sbr[c] = row+0
                        k0sbc[c] = col+2
                        k0sbv[c] += pi*i1*k1*(2*(-1)**(i1 + k1) - 2)*((j1*(B11sb*(b*b)*(k1*k1) + (a*a)*(l1*l1)*(B12sb + 2*B66sb))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b) + l1*(B11sb*(b*b)*(k1*k1) + (a*a)*(B12sb*(l1*l1) + 2*B66sb*(j1*j1)))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) - (j1*(B11sb*(b*b)*(k1*k1) + (a*a)*(l1*l1)*(B12sb + 2*B66sb))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b) + l1*(B11sb*(b*b)*(k1*k1) + (a*a)*(B12sb*(l1*l1) + 2*B66sb*(j1*j1)))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/((a*a)*b*((i1*i1) - (k1*k1))*((j1*j1) - (l1*l1)))
                        c += 1
                        k0sbr[c] = row+1
                        k0sbc[c] = col+0
                        ...
                        k0sbr[c] = row+1
                        k0sbc[c] = col+2
                        k0sbv[c] += pi*i1*k1*(2*(-1)**(i1 + k1) - 2)*((j1*(B16sb*(b*b)*(k1*k1) + 3*B26sb*(a*a)*(l1*l1))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b) + l1*(B16sb*(b*b)*(k1*k1) + B26sb*(a*a)*(2*(j1*j1) + (l1*l1)))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) - (j1*(B16sb*(b*b)*(k1*k1) + 3*B26sb*(a*a)*(l1*l1))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b) + l1*(B16sb*(b*b)*(k1*k1) + B26sb*(a*a)*(2*(j1*j1) + (l1*l1)))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/((a*a)*b*((i1*i1) - (k1*k1))*((j1*j1) - (l1*l1)))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+0
                        k0sbv[c] += pi*i1*k1*(2*(-1)**(i1 + k1) - 2)*(-(j1*(B11sb*(b*b)*(i1*i1) + (a*a)*(B12sb*(j1*j1) + 2*B66sb*(l1*l1)))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b) + l1*(B11sb*(b*b)*(i1*i1) + (a*a)*(j1*j1)*(B12sb + 2*B66sb))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) + (j1*(B11sb*(b*b)*(i1*i1) + (a*a)*(B12sb*(j1*j1) + 2*B66sb*(l1*l1)))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b) + l1*(B11sb*(b*b)*(i1*i1) + (a*a)*(j1*j1)*(B12sb + 2*B66sb))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/((a*a)*b*((i1*i1) - (k1*k1))*((j1*j1) - (l1*l1)))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+1
                        k0sbv[c] += pi*i1*k1*(2*(-1)**(i1 + k1) - 2)*(-(j1*(B16sb*(b*b)*(i1*i1) + B26sb*(a*a)*((j1*j1) + 2*(l1*l1)))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b) + l1*(B16sb*(b*b)*(i1*i1) + 3*B26sb*(a*a)*(j1*j1))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) + (j1*(B16sb*(b*b)*(i1*i1) + B26sb*(a*a)*((j1*j1) + 2*(l1*l1)))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b) + l1*(B16sb*(b*b)*(i1*i1) + 3*B26sb*(a*a)*(j1*j1))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/((a*a)*b*((i1*i1) - (k1*k1))*((j1*j1) - (l1*l1)))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+2
                        k0sbv[c] += (pi*pi)*i1*k1*(4*(-1)**(i1 + k1) - 4)*(-j1*(D16sb*(b*b)*(k1*k1) + D26sb*(a*a)*(l1*l1))*((j1*sin(pi*j1*ys/b)*cos(pi*l1*ys/b) - l1*sin(pi*l1*ys/b)*cos(pi*j1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b) + (j1*sin(pi*l1*ys/b)*cos(pi*j1*ys/b) - l1*sin(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b)) + l1*(D16sb*(b*b)*(i1*i1) + D26sb*(a*a)*(j1*j1))*((j1*sin(pi*j1*ys/b)*cos(pi*l1*ys/b) - l1*sin(pi*l1*ys/b)*cos(pi*j1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) + (j1*sin(pi*l1*ys/b)*cos(pi*j1*ys/b) - l1*sin(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b)))/((a*a)*(b*b)*((i1*i1) - (k1*k1))*((j1*j1) - (l1*l1)))
                        ...
                        k0sbr[c] = row+0
                        k0sbc[c] = col+2
                        k0sbv[c] += -(pi*pi)*((-j1*l1*(3*B16sb*(b*b)*(i1*i1) + B26sb*(a*a)*(l1*l1))*sin(pi*j1*ys/b)*cos(pi*l1*ys/b) + (B16sb*(b*b)*(i1*i1)*((j1*j1) + 2*(l1*l1)) + B26sb*(a*a)*(j1*j1)*(l1*l1))*sin(pi*l1*ys/b)*cos(pi*j1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) + (-j1*l1*(3*B16sb*(b*b)*(i1*i1) + B26sb*(a*a)*(l1*l1))*sin(pi*l1*ys/b)*cos(pi*j1*ys/b) + (B16sb*(b*b)*(i1*i1)*((j1*j1) + 2*(l1*l1)) + B26sb*(a*a)*(j1*j1)*(l1*l1))*sin(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/(a*(b*b)*(-(j1*j1) + (l1*l1)))
                        c += 1
                        k0sbr[c] = row+1
                        k0sbc[c] = col+0
                        k0sbv[c] += pi*((j1*(A16sb*(b*b)*(i1*i1) + A26sb*(a*a)*(l1*l1))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b) + l1*(A16sb*(b*b)*(i1*i1) + A26sb*(a*a)*(j1*j1))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) - (j1*(A16sb*(b*b)*(i1*i1) + A26sb*(a*a)*(l1*l1))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b) + l1*(A16sb*(b*b)*(i1*i1) + A26sb*(a*a)*(j1*j1))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/(a*b*((j1*j1) - (l1*l1)))
                        ...
                        k0sbr[c] = row+1
                        k0sbc[c] = col+2
                        k0sbv[c] += (pi*pi)*((j1*l1*(B22sb*(a*a)*(l1*l1) + (b*b)*(i1*i1)*(B12sb + 2*B66sb))*sin(pi*j1*ys/b)*cos(pi*l1*ys/b) - (B22sb*(a*a)*(j1*j1)*(l1*l1) + (b*b)*(i1*i1)*(B12sb*(j1*j1) + 2*B66sb*(l1*l1)))*sin(pi*l1*ys/b)*cos(pi*j1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) + (j1*l1*(B22sb*(a*a)*(l1*l1) + (b*b)*(i1*i1)*(B12sb + 2*B66sb))*sin(pi*l1*ys/b)*cos(pi*j1*ys/b) - (B22sb*(a*a)*(j1*j1)*(l1*l1) + (b*b)*(i1*i1)*(B12sb*(j1*j1) + 2*B66sb*(l1*l1)))*sin(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/(a*(b*b)*(-(j1*j1) + (l1*l1)))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+0
                        k0sbv[c] += (pi*pi)*((-j1*l1*(3*B16sb*(b*b)*(i1*i1) + B26sb*(a*a)*(j1*j1))*sin(pi*j1*ys/b)*cos(pi*l1*ys/b) + (B16sb*(b*b)*(i1*i1)*(2*(j1*j1) + (l1*l1)) + B26sb*(a*a)*(j1*j1)*(l1*l1))*sin(pi*l1*ys/b)*cos(pi*j1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) + (-j1*l1*(3*B16sb*(b*b)*(i1*i1) + B26sb*(a*a)*(j1*j1))*sin(pi*l1*ys/b)*cos(pi*j1*ys/b) + (B16sb*(b*b)*(i1*i1)*(2*(j1*j1) + (l1*l1)) + B26sb*(a*a)*(j1*j1)*(l1*l1))*sin(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/(a*(b*b)*(-(j1*j1) + (l1*l1)))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+1
                        k0sbv[c] += (pi*pi)*((-j1*l1*(B22sb*(a*a)*(j1*j1) + (b*b)*(i1*i1)*(B12sb + 2*B66sb))*sin(pi*j1*ys/b)*cos(pi*l1*ys/b) + (B22sb*(a*a)*(j1*j1)*(l1*l1) + (b*b)*(i1*i1)*(B12sb*(l1*l1) + 2*B66sb*(j1*j1)))*sin(pi*l1*ys/b)*cos(pi*j1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) + (-j1*l1*(B22sb*(a*a)*(j1*j1) + (b*b)*(i1*i1)*(B12sb + 2*B66sb))*sin(pi*l1*ys/b)*cos(pi*j1*ys/b) + (B22sb*(a*a)*(j1*j1)*(l1*l1) + (b*b)*(i1*i1)*(B12sb*(l1*l1) + 2*B66sb*(j1*j1)))*sin(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/(a*(b*b)*(-(j1*j1) + (l1*l1)))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+2
                        k0sbv[c] += (pi*pi*pi)*((j1*(D11sb*(b*b*b*b)*(i1*i1*i1*i1) + D22sb*(a*a*a*a)*(j1*j1)*(l1*l1) + (a*a)*(b*b)*(i1*i1)*(D12sb*((j1*j1) + (l1*l1)) + 4*D66sb*(l1*l1)))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b) + l1*(D11sb*(b*b*b*b)*(i1*i1*i1*i1) + D22sb*(a*a*a*a)*(j1*j1)*(l1*l1) + (a*a)*(b*b)*(i1*i1)*(D12sb*((j1*j1) + (l1*l1)) + 4*D66sb*(j1*j1)))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) - (j1*(D11sb*(b*b*b*b)*(i1*i1*i1*i1) + D22sb*(a*a*a*a)*(j1*j1)*(l1*l1) + (a*a)*(b*b)*(i1*i1)*(D12sb*((j1*j1) + (l1*l1)) + 4*D66sb*(l1*l1)))*cos(pi*j1*ys/b)*cos(pi*l1*ys/b) + l1*(D11sb*(b*b*b*b)*(i1*i1*i1*i1) + D22sb*(a*a*a*a)*(j1*j1)*(l1*l1) + (a*a)*(b*b)*(i1*i1)*(D12sb*((j1*j1) + (l1*l1)) + 4*D66sb*(j1*j1)))*sin(pi*j1*ys/b)*sin(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/((a*a*a)*(b*b*b)*((j1*j1) - (l1*l1)))
                        ...
                        k0sbr[c] = row+0
                        k0sbc[c] = col+2
                        k0sbv[c] += 0.25*pi*i1*k1*((-1)**(i1 + k1) - 1)*(-b*(B11sb*(b*b)*(k1*k1) + (a*a)*(j1*j1)*(B12sb - 2*B66sb))*sin(pi*j1*(bb - 2*ys)/b) - b*(B11sb*(b*b)*(k1*k1) + (a*a)*(j1*j1)*(B12sb - 2*B66sb))*sin(pi*j1*(bb + 2*ys)/b) + 2*pi*bb*j1*(B11sb*(b*b)*(k1*k1) + (a*a)*(j1*j1)*(B12sb + 2*B66sb)))/((a*a)*(b*b)*j1*((i1*i1) - (k1*k1)))
                        c += 1
                        k0sbr[c] = row+1
                        k0sbc[c] = col+0
                        k0sbv[c] += i1*k1*((-1)**(i1 + k1) - 1)*(-A12sb + A66sb)*sin(pi*bb*j1/b)*sin(2*pi*j1*ys/b)/(2.0*(i1*i1) - 2.0*(k1*k1))
                        ...
                        k0sbr[c] = row+1
                        k0sbc[c] = col+2
                        k0sbv[c] += 0.25*pi*i1*k1*((-1)**(i1 + k1) - 1)*(b*(-B16sb*(b*b)*(k1*k1) + B26sb*(a*a)*(j1*j1))*sin(pi*j1*(bb - 2*ys)/b) + b*(-B16sb*(b*b)*(k1*k1) + B26sb*(a*a)*(j1*j1))*sin(pi*j1*(bb + 2*ys)/b) + 2*pi*bb*j1*(B16sb*(b*b)*(k1*k1) + 3*B26sb*(a*a)*(j1*j1)))/((a*a)*(b*b)*j1*((i1*i1) - (k1*k1)))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+0
                        k0sbv[c] += -0.25*pi*i1*k1*((-1)**(i1 + k1) - 1)*(-b*(B11sb*(b*b)*(i1*i1) + (a*a)*(j1*j1)*(B12sb - 2*B66sb))*sin(pi*j1*(bb - 2*ys)/b) - b*(B11sb*(b*b)*(i1*i1) + (a*a)*(j1*j1)*(B12sb - 2*B66sb))*sin(pi*j1*(bb + 2*ys)/b) + 2*pi*bb*j1*(B11sb*(b*b)*(i1*i1) + (a*a)*(j1*j1)*(B12sb + 2*B66sb)))/((a*a)*(b*b)*j1*((i1*i1) - (k1*k1)))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+1
                        k0sbv[c] += -0.25*pi*i1*k1*((-1)**(i1 + k1) - 1)*(-b*(B16sb*(b*b)*(i1*i1) - B26sb*(a*a)*(j1*j1))*(sin(pi*j1*(bb - 2*ys)/b) + sin(pi*j1*(bb + 2*ys)/b)) + 2*pi*bb*j1*(B16sb*(b*b)*(i1*i1) + 3*B26sb*(a*a)*(j1*j1)))/((a*a)*(b*b)*j1*(i1 - k1)*(i1 + k1))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+2
                        ...
                        k0sbr[c] = row+0
                        k0sbc[c] = col+2
                        k0sbv[c] += 0.25*(pi*pi)*(-B16sb*(b*b)*(i1*i1) + B26sb*(a*a)*(j1*j1))*sin(pi*bb*j1/b)*sin(2*pi*j1*ys/b)/(a*(b*b))
                        c += 1
                        k0sbr[c] = row+1
                        k0sbc[c] = col+0
                        k0sbv[c] += 0.125*pi*A16sb*(i1*i1)*(-b*(sin(pi*j1*(bb - 2*ys)/b) + sin(pi*j1*(bb + 2*ys)/b)) + 2*pi*bb*j1)/(a*j1) + 0.125*pi*A26sb*a*j1*(b*(sin(pi*j1*(bb - 2*ys)/b) + sin(pi*j1*(bb + 2*ys)/b)) + 2*pi*bb*j1)/(b*b)
                        ...
                        k0sbr[c] = row+1
                        k0sbc[c] = col+2
                        k0sbv[c] += 0.25*(pi*pi)*(B22sb*(a*a)*(j1*j1) + (b*b)*(i1*i1)*(B12sb - 2*B66sb))*sin(pi*bb*j1/b)*sin(2*pi*j1*ys/b)/(a*(b*b))
                        c += 1
                        k0sbr[c] = row+2
                        k0sbc[c] = col+0
                        k0sbv[c] += 0.25*(pi*pi)*(-B16sb*(b*b)*(i1*i1) + B26sb*(a*a)*(j1*j1))*sin(pi*bb*j1/b)*sin(2*pi*j1*ys/b)/(a*(b*b))
                        ...
                        k0sbr[c] = row+2
                        k0sbc[c] = col+2
                        k0sbv[c] += 0.125*(pi*pi*pi)*(-b*(D11sb*(b*b*b*b)*(i1*i1*i1*i1) + D22sb*(a*a*a*a)*(j1*j1*j1*j1) + 2*(a*a)*(b*b)*(i1*i1)*(j1*j1)*(D12sb - 2*D66sb))*sin(pi*j1*(bb - 2*ys)/b) - b*(D11sb*(b*b*b*b)*(i1*i1*i1*i1) + D22sb*(a*a*a*a)*(j1*j1*j1*j1) + 2*(a*a)*(b*b)*(i1*i1)*(j1*j1)*(D12sb - 2*D66sb))*sin(pi*j1*(bb + 2*ys)/b) + 2*pi*bb*j1*(D11sb*(b*b*b*b)*(i1*i1*i1*i1) + D22sb*(a*a*a*a)*(j1*j1*j1*j1) + 2*(a*a)*(b*b)*(i1*i1)*(j1*j1)*(D12sb + 2*D66sb)))/((a*a*a)*(b*b*b*b)*j1)
...
def fk0sf(double bf, double df, double ys, double a, double b,
            ...
            for k1 in range(1, m1+1):
                for l1 in range(1, n1+1):
                    ...
                    if k1 != i1 and l1 != j1:
                        ...
                        kMsbr[c] = row+0
                        kMsbc[c] = col+0
                        kMsbv[c] += a*b*hb*mus*((j1*sin(pi*j1*ys/b)*sin(pi*l1*ys/b) + l1*cos(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) - (j1*cos(pi*j1*ys/b)*cos(pi*l1*ys/b) + l1*sin(pi*j1*ys/b)*sin(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/(pi*((j1*j1) - (l1*l1)))
                        c += 1
                        kMsbr[c] = row+1
                        kMsbc[c] = col+1
                        kMsbv[c] += a*b*hb*mus*((j1*sin(pi*j1*ys/b)*sin(pi*l1*ys/b) + l1*cos(pi*j1*ys/b)*cos(pi*l1*ys/b))*sin(0.5*pi*bb*j1/b)*cos(0.5*pi*bb*l1/b) - (j1*cos(pi*j1*ys/b)*cos(pi*l1*ys/b) + l1*sin(pi*j1*ys/b)*sin(pi*l1*ys/b))*sin(0.5*pi*bb*l1/b)*cos(0.5*pi*bb*j1/b))/(pi*((j1*j1) - (l1*l1)))
                        ...
                        kMsbr[c] = row+0
                        kMsbc[c] = col+0
                        kMsbv[c] += 0.125*a*hb*mus*(-b*(sin(pi*j1*(bb - 2*ys)/b) + sin(pi*j1*(bb + 2*ys)/b)) + 2*pi*bb*j1)/(pi*j1)
                        c += 1
                        kMsbr[c] = row+1
                        kMsbc[c] = col+1
                        kMsbv[c] += 0.125*a*hb*mus*(-b*(sin(pi*j1*(bb - 2*ys)/b) + sin(pi*j1*(bb + 2*ys)/b)) + 2*pi*bb*j1)/(pi*j1)
                        ...
                        kMsbr[c] = row+2
                        kMsbc[c] = col+2
                        kMsbv[c] += 0.0104166666666667*hb*mus*(-b*(12*(a*a)*(b*b) + (pi*pi)*(12*(db*db) + (hb*hb))*(-a*j1 + b*i1)*(a*j1 + b*i1))*(sin(pi*j1*(bb - 2*ys)/b) + sin(pi*j1*(bb + 2*ys)/b)) + 2*pi*bb*j1*(12*(a*a)*(b*b) + (pi*pi)*(12*(db*db) + (hb*hb))*((a*a)*(j1*j1) + (b*b)*(i1*i1))))/(pi*a*(b*b)*j1)
