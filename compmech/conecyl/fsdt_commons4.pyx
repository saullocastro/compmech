...
cdef void cfuvw(double *c, int m1, int m2, int n2, double r2,
    ...
    for j2 in range(1, n2+1):
        ...
        for i2 in range(1, m2+1):
            ...
            phix += c[col+6]*sinbi*sinbj
            phix += c[col+7]*sinbi*cosbj
            phix += c[col+8]*cosbi*sinbj
            phix += c[col+9]*cosbi*cosbj

            phit += c[col+10]*sinbi*sinbj
            phit += c[col+11]*sinbi*cosbj
...
cdef cfg(double[:, ::1] gss, int m1, int m2, int n2,
    ...
    for i2 in range(1, m2+1):
        ...
        for j2 in range(1, n2+1):
            ...
            gss[3, col+6] = sinbi*sinbj
            gss[3, col+7] = sinbi*cosbj
            gss[3, col+8] = cosbi*sinbj
            gss[3, col+9] = cosbi*cosbj

            gss[4, col+10] = sinbi*sinbj
            gss[4, col+11] = sinbi*cosbj
