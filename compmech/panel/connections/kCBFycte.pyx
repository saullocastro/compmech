...
def fkCBFycte11(double kt, double kr, double a1, double b1,
...
def fkCBFycte12(double kt, double kr, double a1, double b1, double b2,
...
def fkCBFycte22(double kt, double kr, double a1, double b2, int m2, int n2,
          double ycte2,
          double u1tx2, double u1rx2, double u2tx2, double u2rx2,
          double v1tx2, double v1rx2, double v2tx2, double v2rx2,
          double w1tx2, double w1rx2, double w2tx2, double w2rx2,
