...
def fk0_cyl(double r1, double L, double tmin, double tmax,
    ...
    fdim = 36 + 29*m1*n1 + 17*m1*n1*m1*n1//2
    ...
    k0r[c] = 1
    k0c[c] = 1
    k0v[c] += 1.33333333333333*A11*r*(tmax - tmin)/L
    c += 1
    k0r[c] = 1
    k0c[c] = 2
    k0v[c] += 1.5*A11*r*(tmax - tmin)/L
    c += 1
    k0r[c] = 1
    k0c[c] = 3
    k0v[c] += A12
    ...
    k0r[c] = 3
    k0c[c] = 4
    k0v[c] += 0.25*L*(4*A22 + A44*(tmax - tmin)**2)/(r*(tmax - tmin))
    c += 1
    k0r[c] = 3
    k0c[c] = 5
    k0v[c] += 0.2*L*(5*A22 + A44*(tmax - tmin)**2)/(r*(tmax - tmin))
    c += 1
    k0r[c] = 4
    k0c[c] = 0
    k0v[c] += A12
    ...
    k0r[c] = 4
    k0c[c] = 4
    k0v[c] += 0.0666666666666667*L*(20*A22 + 3*A44*(tmax - tmin)**2)/(r*(tmax - tmin))
    c += 1
    k0r[c] = 4
    k0c[c] = 5
    k0v[c] += 0.166666666666667*L*(9*A22 + A44*(tmax - tmin)**2)/(r*(tmax - tmin))
    c += 1
    k0r[c] = 5
    k0c[c] = 0
    k0v[c] += A12
    ...
    k0r[c] = 5
    k0c[c] = 5
    k0v[c] += 0.0285714285714286*L*(63*A22 + 5*A44*(tmax - tmin)**2)/(r*(tmax - tmin))
    ...
    for k1 in range(m1):
        for l1 in range(n1):
            ...
            if k1 != 0 and l1 != 0:
                ...
                k0r[c] = 1
                k0c[c] = col+0
                k0v[c] += A16*(2*(-1)**k1 - 2)*((-1)**l1 - 1)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 1
                k0c[c] = col+1
                k0v[c] += A12*(2*(-1)**k1 - 2)*((-1)**l1 - 1)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 1
                k0c[c] = col+3
                k0v[c] += B16*(2*(-1)**k1 - 2)*((-1)**l1 - 1)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 1
                k0c[c] = col+4
                k0v[c] += B12*(2*(-1)**k1 - 2)*((-1)**l1 - 1)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 2
                k0c[c] = col+0
                k0v[c] += 6*(-1)**k1*A16*((-1)**l1 - 1)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 2
                k0c[c] = col+1
                k0v[c] += 6*(-1)**k1*A12*((-1)**l1 - 1)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 2
                k0c[c] = col+3
                k0v[c] += 6*(-1)**k1*B16*((-1)**l1 - 1)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 2
                k0c[c] = col+4
                k0v[c] += 6*(-1)**k1*B12*((-1)**l1 - 1)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 3
                k0c[c] = col+2
                k0v[c] += (-1)**(k1 - 1)*A45*(2*(-1)**l1 - 2)*(tmax - tmin)/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 4
                k0c[c] = col+0
                k0v[c] += (-1)**(k1 - 1)*A12*(-4*(-1)**l1 + 4)/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 4
                k0c[c] = col+1
                k0v[c] += A26*(2*(-1)**k1 - 2)*((-1)**l1 - 1)/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 4
                k0c[c] = col+2
                k0v[c] += -2*(-1)**l1*A45*((-1)**k1 - 1)*(tmax - tmin)/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 4
                k0c[c] = col+3
                k0v[c] += B12*(2*(-1)**k1 - 2)*((-1)**l1 - 1)/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 4
                k0c[c] = col+4
                k0v[c] += B26*(2*(-1)**k1 - 2)*((-1)**l1 - 1)/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 5
                k0c[c] = col+0
                k0v[c] += -12*(-1)**l1*(-1)**(k1 - 1)*A12/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 5
                k0c[c] = col+1
                k0v[c] += 6*(-1)**l1*A26*((-1)**k1 - 1)/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 5
                k0c[c] = col+2
                k0v[c] += -A45*((-1)**k1 - 1)*(tmax - tmin)*(3*(-1)**l1*((pi*pi)*(l1*l1) - 2) + 6)/((pi*pi*pi*pi)*(l1*l1*l1*l1))
                c += 1
                k0r[c] = 5
                k0c[c] = col+3
                k0v[c] += 6*(-1)**l1*B12*((-1)**k1 - 1)/((pi*pi)*(l1*l1))
                c += 1
                k0r[c] = 5
                k0c[c] = col+4
                k0v[c] += 6*(-1)**l1*B26*((-1)**k1 - 1)/((pi*pi)*(l1*l1))
                ...
                k0r[c] = 4
                k0c[c] = col+0
                k0v[c] += 2*(-1)**l1*A26*L/(r*(tmax - tmin))
                c += 1
                k0r[c] = 4
                k0c[c] = col+1
                k0v[c] += 2*(-1)**l1*L*((pi*pi)*A22*(l1*l1) + A44*(tmax - tmin)**2)/((pi*pi)*(l1*l1)*r*(tmax - tmin))
                c += 1
                k0r[c] = 4
                k0c[c] = col+2
                k0v[c] += L*((-1)**l1*(2*A22 - (pi*pi)*A44*(l1*l1) + 2*A44) - 2*A22 - 2*A44)/((pi*pi)*(l1*l1)*r)
                c += 1
                k0r[c] = 4
                k0c[c] = col+3
                k0v[c] += 2*(-1)**l1*L*(-A45*r*(tmax - tmin)**2 + (pi*pi)*B26*(l1*l1))/((pi*pi)*(l1*l1)*r*(tmax - tmin))
                c += 1
                k0r[c] = 4
                k0c[c] = col+4
                k0v[c] += 2*(-1)**l1*L*(-A44*r*(tmax - tmin)**2 + (pi*pi)*B22*(l1*l1))/((pi*pi)*(l1*l1)*r*(tmax - tmin))
                c += 1
                k0r[c] = 5
                k0c[c] = col+0
                k0v[c] += 3*A26*L*((-1)**l1*((pi*pi)*(l1*l1) - 2) + 2)/((pi*pi)*(l1*l1)*r*(tmax - tmin))
                c += 1
                k0r[c] = 5
                k0c[c] = col+1
                k0v[c] += 3*L*((pi*pi)*A22*(l1*l1) + A44*(tmax - tmin)**2)*((-1)**l1*(pi*pi)*(l1*l1) - 2*(-1)**l1 + 2)/((pi*pi*pi*pi)*(l1*l1*l1*l1)*r*(tmax - tmin))
                c += 1
                k0r[c] = 5
                k0c[c] = col+2
                k0v[c] += (-1)**l1*L*(6*A22 - (pi*pi)*A44*(l1*l1) + 6*A44)/((pi*pi)*(l1*l1)*r)
                c += 1
                k0r[c] = 5
                k0c[c] = col+3
                k0v[c] += 3*L*(-A45*r*(tmax - tmin)**2 + (pi*pi)*B26*(l1*l1))*((-1)**l1*(pi*pi)*(l1*l1) - 2*(-1)**l1 + 2)/((pi*pi*pi*pi)*(l1*l1*l1*l1)*r*(tmax - tmin))
                c += 1
                k0r[c] = 5
                k0c[c] = col+4
                k0v[c] += 3*L*(-A44*r*(tmax - tmin)**2 + (pi*pi)*B22*(l1*l1))*((-1)**l1*(pi*pi)*(l1*l1) - 2*(-1)**l1 + 2)/((pi*pi*pi*pi)*(l1*l1*l1*l1)*r*(tmax - tmin))
                ...
                k0r[c] = 1
                k0c[c] = col+0
                k0v[c] += 2*(-1)**k1*A11*r*(tmax - tmin)/L
                c += 1
                k0r[c] = 1
                k0c[c] = col+1
                k0v[c] += 2*(-1)**k1*A16*r*(tmax - tmin)/L
                c += 1
                k0r[c] = 1
                k0c[c] = col+2
                k0v[c] += A12*(2*(-1)**k1 - 2)*(tmax - tmin)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 1
                k0c[c] = col+3
                k0v[c] += 2*(-1)**k1*B11*r*(tmax - tmin)/L
                c += 1
                k0r[c] = 1
                k0c[c] = col+4
                k0v[c] += 2*(-1)**k1*B16*r*(tmax - tmin)/L
                c += 1
                k0r[c] = 2
                k0c[c] = col+0
                k0v[c] += 3*A11*r*(tmax - tmin)*((-1)**k1*((pi*pi)*(k1*k1) - 2) + 2)/((pi*pi)*L*(k1*k1))
                c += 1
                k0r[c] = 2
                k0c[c] = col+1
                k0v[c] += 3*A16*r*(tmax - tmin)*((-1)**k1*((pi*pi)*(k1*k1) - 2) + 2)/((pi*pi)*L*(k1*k1))
                c += 1
                k0r[c] = 2
                k0c[c] = col+2
                k0v[c] += 6*(-1)**k1*A12*(tmax - tmin)/((pi*pi)*(k1*k1))
                c += 1
                k0r[c] = 2
                k0c[c] = col+3
                k0v[c] += 3*B11*r*(tmax - tmin)*((-1)**k1*((pi*pi)*(k1*k1) - 2) + 2)/((pi*pi)*L*(k1*k1))
                c += 1
                k0r[c] = 2
                k0c[c] = col+4
                k0v[c] += 3*B16*r*(tmax - tmin)*((-1)**k1*((pi*pi)*(k1*k1) - 2) + 2)/((pi*pi)*L*(k1*k1))
                c += 1
                k0r[c] = 3
                k0c[c] = col+0
                k0v[c] += A12*((-1)**k1 - 1)
                ...
                k0r[c] = 4
                k0c[c] = col+2
                k0v[c] += -0.333333333333333*A45*((-1)**k1 - 1)*(tmax - tmin)
                c += 1
                k0r[c] = 4
                k0c[c] = col+3
                k0v[c] += B12*((-1)**k1 - 1)
                ...
                k0r[c] = 5
                k0c[c] = col+2
                k0v[c] += -0.25*A45*((-1)**k1 - 1)*(tmax - tmin)
                c += 1
                k0r[c] = 5
                k0c[c] = col+3
                k0v[c] += B12*((-1)**k1 - 1)
                ...
                k0r[c] = 4
                k0c[c] = col+1
                k0v[c] += 0.333333333333333*A44*L*(tmax - tmin)/r
                c += 1
                k0r[c] = 4
                k0c[c] = col+2
                k0v[c] += A22*L/r
                ...
                k0r[c] = 4
                k0c[c] = col+3
                k0v[c] += 0.333333333333333*A45*L*(-tmax + tmin)
                c += 1
                k0r[c] = 4
                k0c[c] = col+4
                k0v[c] += 0.333333333333333*A44*L*(-tmax + tmin)
                c += 1
                k0r[c] = 5
                k0c[c] = col+1
                k0v[c] += 0.25*A44*L*(tmax - tmin)/r
                c += 1
                k0r[c] = 5
                k0c[c] = col+2
                k0v[c] += A22*L/r
                ...
                k0r[c] = 5
                k0c[c] = col+3
                k0v[c] += 0.25*A45*L*(-tmax + tmin)
                c += 1
                k0r[c] = 5
                k0c[c] = col+4
                k0v[c] += 0.25*A44*L*(-tmax + tmin)
            ...
            for k1 in range(m1):
                for l1 in range(n1):
                    ...
                    if k1 != i1 and l1 != j1:
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+3
                        k0v[c] += -B16*((-1)**(i1 + k1) - 1)*((-1)**(j1 + l1) - 1)*((i1*i1)*(l1*l1) + (j1*j1)*(k1*k1))/(((i1*i1) - (k1*k1))*(j1 - l1)*(j1 + l1))
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+4
                        ...
                        k0r[c] = row+1
                        k0c[c] = col+4
                        k0v[c] += -B26*((-1)**(i1 + k1) - 1)*((-1)**(j1 + l1) - 1)*((i1*i1)*(l1*l1) + (j1*j1)*(k1*k1))/(((i1*i1) - (k1*k1))*(j1 - l1)*(j1 + l1))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+2
                        k0v[c] += -A45*((-1)**(i1 + k1) - 1)*((-1)**(j1 + l1) - 1)*((i1*i1)*(l1*l1) + (j1*j1)*(k1*k1))/(((i1*i1) - (k1*k1))*(j1 - l1)*(j1 + l1))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+0
                        k0v[c] += -B16*((-1)**(i1 + k1) - 1)*((-1)**(j1 + l1) - 1)*((i1*i1)*(l1*l1) + (j1*j1)*(k1*k1))/(((i1*i1) - (k1*k1))*(j1 - l1)*(j1 + l1))
                        ...
                        k0r[c] = row+4
                        k0c[c] = col+4
                        k0v[c] += -D26*((-1)**(i1 + k1) - 1)*((-1)**(j1 + l1) - 1)*((i1*i1)*(l1*l1) + (j1*j1)*(k1*k1))/(((i1*i1) - (k1*k1))*(j1 - l1)*(j1 + l1))
