...
def fk0_cyl(double r1, double L, double tmin, double tmax,
    ...
    fdim = (16 + 4 + 8*m2 + 8*n3 + 6*m4*n4 + 2*m4*n4 + 4*m2*m2 + 4*m2*n3 +
            2*m2*m4*n4 + 4*n3 + 8*n3*m4*n4 + 17*m4*n4*m4*n4)
    ...
    k0r[c] = 2
    k0c[c] = 2
    k0v[c] += (tmax - tmin)*(0.333333333333333*A44*L/r + A66*r/L)
    c += 1
    k0r[c] = 2
    k0c[c] = 3
    k0v[c] += 0.25*(4*A26*r + A44*L*(tmax - tmin))/r
    c += 1
    k0r[c] = 3
    k0c[c] = 0
    k0v[c] += A12
    ...
    for k2 in range(1, m2+1):
        ...
        k0r[c] = 2
        k0c[c] = col+0
        k0v[c] += ((-1)**k2 - 1)*(tmax - tmin)*(-A45*(L*L) + (pi*pi)*B16*(k2*k2)*r)/((pi*pi)*L*(k2*k2))
        c += 1
        k0r[c] = 2
        k0c[c] = col+1
        k0v[c] += ((-1)**k2 - 1)*(tmax - tmin)*(-A44*(L*L) + (pi*pi)*B66*(k2*k2)*r)/((pi*pi)*L*(k2*k2))
        c += 1
        k0r[c] = 3
        k0c[c] = col+0
        k0v[c] += B12*((-1)**k2 - 1)
    ...
    for l3 in range(1, n3+1):
        ...
        k0r[c] = 1
        k0c[c] = col+0
        k0v[c] += B66*L*((-1)**l3 - 1)/(r*(tmax - tmin))
        c += 1
        k0r[c] = 1
        k0c[c] = col+1
        k0v[c] += B26*L*((-1)**l3 - 1)/(r*(tmax - tmin))
        c += 1
        k0r[c] = 2
        k0c[c] = col+0
        k0v[c] += B66*((-1)**l3 - 1)
        ...
        k0r[c] = 3
        k0c[c] = col+0
        k0v[c] += L*((-1)**l3 - 1)*(-A45*r*(tmax - tmin)**2 + (pi*pi)*B26*(l3*l3))/((pi*pi)*(l3*l3)*r*(tmax - tmin))
        c += 1
        k0r[c] = 3
        k0c[c] = col+1
        k0v[c] += L*((-1)**l3 - 1)*(-A44*r*(tmax - tmin)**2 + (pi*pi)*B22*(l3*l3))/((pi*pi)*(l3*l3)*r*(tmax - tmin))
    ...
    for l4 in range(1, n4+1):
        for k4 in range(1, m4+1):
            ...
            k0r[c] = 0
            k0c[c] = col+2
            k0v[c] += (-1)**(k4 - 1)*A12*(-2*(-1)**l4 + 2)*(tmax - tmin)/((pi*pi)*k4*l4)
            c += 1
            k0r[c] = 1
            k0c[c] = col+2
            k0v[c] += (-1)**(k4 - 1)*A26*L*(-2*(-1)**l4 + 2)/((pi*pi)*k4*l4*r)
            c += 1
            k0r[c] = 2
            k0c[c] = col+1
            k0v[c] += (-1)**k4*A44*L*((-1)**l4 - 1)*(tmax - tmin)/((pi*pi)*k4*l4*r)
            c += 1
            k0r[c] = 2
            k0c[c] = col+2
            k0v[c] += ((-1)**k4 - 1)*((-1)**l4 - 1)*(A26 + A45)*(tmax - tmin)/((pi*pi)*k4*l4)
            c += 1
            k0r[c] = 3
            k0c[c] = col+1
            k0v[c] += -2*(-1)**l4*(-1)**(k4 - 1)*A44*L*(tmax - tmin)/((pi*pi)*k4*l4*r)
            c += 1
            k0r[c] = 3
            k0c[c] = col+2
            k0v[c] += -2*(-1)**(k4 - 1)*L*((-1)**l4 - 1)*(A22 + A44)/((pi*pi)*k4*l4*r)
    ...
    for k4 in range(1, m4+1):
        for l4 in range(1, n4+1):
            ...
            k0r[c] = row+0
            k0c[c] = col+1
            k0v[c] += (-1)**(k4 - 1)*A45*L*(2*(-1)**l4 - 2)*(tmax - tmin)/((pi*pi)*k4*l4)
            c += 1
            k0r[c] = row+1
            k0c[c] = col+1
            k0v[c] += (-1)**(k4 - 1)*A44*L*(2*(-1)**l4 - 2)*(tmax - tmin)/((pi*pi)*k4*l4)
    ...
    for i2 in range(1, m2+1):
        ...
        for l3 in range(1, n3+1):
            ...
            k0r[c] = row+0
            k0c[c] = col+0
            k0v[c] += (-1)**(i2 - 1)*D16*(-2*(-1)**l3 + 2)
            c += 1
            k0r[c] = row+0
            k0c[c] = col+1
            k0v[c] += (-1)**(i2 - 1)*D12*(-2*(-1)**l3 + 2)
            c += 1
            k0r[c] = row+1
            k0c[c] = col+0
            k0v[c] += (-1)**(i2 - 1)*D66*(-2*(-1)**l3 + 2)
            c += 1
            k0r[c] = row+1
            k0c[c] = col+1
            k0v[c] += (-1)**(i2 - 1)*D26*(-2*(-1)**l3 + 2)
        ...
        for k4 in range(1, m4+1):
            for l4 in range(1, n4+1):
                ...
                if k4 == i2:
                    ...
                    k0r[c] = row+0
                    k0c[c] = col+2
                    k0v[c] += -(-1)**(l4 - 1)*i2*(tmax - tmin)*(-A55*r + B12)/l4
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+2
                    k0v[c] += -(-1)**(l4 - 1)*i2*(tmax - tmin)*(-A45*r + B26)/l4
                else:
                    # k0_24 cond_2
                    c += 1
                    k0r[c] = row+0
                    k0c[c] = col+0
                    k0v[c] += -B11*(i2*i2)*k4*r*((-1)**l4 - 1)*((-1)**(i2 + k4) - 1)*(tmax - tmin)/(L*l4*(i2 - k4)*(i2 + k4))
                    c += 1
                    k0r[c] = row+0
                    k0c[c] = col+1
                    k0v[c] += k4*((-1)**l4 - 1)*((-1)**(i2 + k4) - 1)*(tmax - tmin)*(-A45*(L*L) + (pi*pi)*B16*(i2*i2)*r)/((pi*pi)*L*l4*(-(i2*i2) + (k4*k4)))
                    c += 1
                    k0r[c] = row+0
                    k0c[c] = col+3
                    ...
                    k0r[c] = row+1
                    k0c[c] = col+0
                    k0v[c] += -B16*(i2*i2)*k4*r*((-1)**l4 - 1)*((-1)**(i2 + k4) - 1)*(tmax - tmin)/(L*l4*(i2 - k4)*(i2 + k4))
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+1
                    k0v[c] += k4*((-1)**l4 - 1)*((-1)**(i2 + k4) - 1)*(tmax - tmin)*(-A44*(L*L) + (pi*pi)*B66*(i2*i2)*r)/((pi*pi)*L*l4*(-(i2*i2) + (k4*k4)))
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+3
                    k0v[c] += D66*(i2*i2)*((-1)**l4 - 1)*((-1)**(i2 + k4) - 1)/((i2*i2) - (k4*k4))
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+4
                    k0v[c] += D26*(i2*i2)*((-1)**l4 - 1)*((-1)**(i2 + k4) - 1)/((i2*i2) - (k4*k4))
    ...
    for j3 in range(1, n3+1):
        ...
        for l3 in range(1, n3+1):
            ...
            if l3 == j3:
                ...
                k0r[c] = row+0
                k0c[c] = col+0
                k0v[c] += 0.5*A55*L*r*(tmax - tmin) + (pi*pi)*D66*L*(j3*j3)/(2*r*tmax - 2*r*tmin)
                c += 1
                k0r[c] = row+0
                k0c[c] = col+1
                k0v[c] += 0.5*A45*L*r*(tmax - tmin) + (pi*pi)*D26*L*(j3*j3)/(2*r*tmax - 2*r*tmin)
                c += 1
                k0r[c] = row+1
                k0c[c] = col+0
                k0v[c] += 0.5*A45*L*r*(tmax - tmin) + (pi*pi)*D26*L*(j3*j3)/(2*r*tmax - 2*r*tmin)
                ...
                k0r[c] = row+1
                k0c[c] = col+1
                k0v[c] += 0.5*A44*L*r*(tmax - tmin) + (pi*pi)*D22*L*(j3*j3)/(2*r*tmax - 2*r*tmin)
            else:
                # k0_33 cond_2
                pass
        ...
        for k4 in range(1, m4+1):
            for l4 in range(1, n4+1):
                ...
                if l4 == j3:
                    ...
                    k0r[c] = row+0
                    k0c[c] = col+2
                    k0v[c] += (-1)**(k4 - 1)*L*j3*(A45*r - B26)/(k4*r)
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+2
                    k0v[c] += (-1)**(k4 - 1)*L*j3*(A44*r - B22)/(k4*r)
                else:
                    # k0_34 cond_2
                    c += 1
                    k0r[c] = row+0
                    k0c[c] = col+0
                    k0v[c] += (-1)**(k4 - 1)*B66*L*(j3*j3)*l4*(2*(-1)**(j3 + l4) - 2)/(k4*r*(j3 - l4)*(j3 + l4)*(tmax - tmin))
                    c += 1
                    k0r[c] = row+0
                    k0c[c] = col+1
                    k0v[c] += (-1)**(k4 - 1)*L*l4*(2*(-1)**(j3 + l4) - 2)*(-A45*r*(tmax - tmin)**2 + (pi*pi)*B26*(j3*j3))/((pi*pi)*k4*r*(j3 - l4)*(j3 + l4)*(tmax - tmin))
                    c += 1
                    k0r[c] = row+0
                    k0c[c] = col+3
                    k0v[c] += (-1)**(k4 - 1)*D16*(j3*j3)*(-2*(-1)**(j3 + l4) + 2)/((j3 - l4)*(j3 + l4))
                    c += 1
                    k0r[c] = row+0
                    k0c[c] = col+4
                    k0v[c] += (-1)**(k4 - 1)*D66*(j3*j3)*(-2*(-1)**(j3 + l4) + 2)/((j3 - l4)*(j3 + l4))
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+0
                    k0v[c] += (-1)**(k4 - 1)*B26*L*(j3*j3)*l4*(2*(-1)**(j3 + l4) - 2)/(k4*r*(j3 - l4)*(j3 + l4)*(tmax - tmin))
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+1
                    k0v[c] += (-1)**(k4 - 1)*L*l4*(2*(-1)**(j3 + l4) - 2)*(-A44*r*(tmax - tmin)**2 + (pi*pi)*B22*(j3*j3))/((pi*pi)*k4*r*(j3 - l4)*(j3 + l4)*(tmax - tmin))
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+3
                    k0v[c] += (-1)**(k4 - 1)*D12*(j3*j3)*(-2*(-1)**(j3 + l4) + 2)/((j3 - l4)*(j3 + l4))
                    c += 1
                    k0r[c] = row+1
                    k0c[c] = col+4
                    k0v[c] += (-1)**(k4 - 1)*D26*(j3*j3)*(-2*(-1)**(j3 + l4) + 2)/((j3 - l4)*(j3 + l4))
            ...
            for k4 in range(1, m4+1):
                for l4 in range(1, n4+1):
                    ...
                    if k4 == i4 and l4 == j4:
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+0
                        k0v[c] += 0.25*(pi*pi)*A11*(i4*i4)*r*(tmax - tmin)/L + (pi*pi)*A66*L*(j4*j4)/(4*r*tmax - 4*r*tmin)
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+1
                        k0v[c] += 0.25*(pi*pi)*A16*(i4*i4)*r*(tmax - tmin)/L + (pi*pi)*A26*L*(j4*j4)/(4*r*tmax - 4*r*tmin)
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+3
                        k0v[c] += -0.5*(pi*pi)*B16*i4*j4
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+4
                        k0v[c] += -0.25*(pi*pi)*i4*j4*(B12 + B66)
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+0
                        k0v[c] += 0.25*(pi*pi)*A16*(i4*i4)*r*(tmax - tmin)/L + (pi*pi)*A26*L*(j4*j4)/(4*r*tmax - 4*r*tmin)
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+2
                        k0v[c] += A12*i4*k4*((-1)**(i4 + k4) - 1)*(tmax - tmin)/(2.0*(i4*i4) - 2.0*(k4*k4))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+2
                        k0v[c] += i4*k4*((-1)**(i4 + k4) - 1)*(A26 + A45)*(tmax - tmin)/(2.0*(i4*i4) - 2.0*(k4*k4))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+0
                        k0v[c] += -A12*i4*k4*((-1)**(i4 + k4) - 1)*(tmax - tmin)/(2.0*(i4*i4) - 2.0*(k4*k4))
                        ...
                        k0r[c] = row+2
                        k0c[c] = col+3
                        k0v[c] += L*i4*j4*((-1)**(i4 + k4) - 1)*(-A45*r + B26)/(r*(2.0*(i4*i4) - 2.0*(k4*k4)))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+4
                        k0v[c] += L*i4*j4*((-1)**(i4 + k4) - 1)*(-A44*r + B22)/(r*(2.0*(i4*i4) - 2.0*(k4*k4)))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+2
                        k0v[c] += L*j4*k4*((-1)**(i4 + k4) - 1)*(-A45*r + B26)/(r*(-2.0*(i4*i4) + 2.0*(k4*k4)))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+2
                        k0v[c] += L*j4*k4*((-1)**(i4 + k4) - 1)*(-A44*r + B22)/(r*(-2.0*(i4*i4) + 2.0*(k4*k4)))
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+0
                        k0v[c] += A16*i4*j4*k4*l4*(-2*(-1)**(i4 + k4) + 2)*((-1)**(j4 + l4) - 1)/(((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4))
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+1
                        k0v[c] += -i4*j4*k4*l4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*(A12 + A66)/(((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4))
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+3
                        k0v[c] += i4*j4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*(B11*(k4*k4)*(r*r)*(tmax - tmin)**2 + B66*(L*L)*(l4*l4))/(L*r*((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+4
                        k0v[c] += i4*j4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*(B16*(k4*k4)*(r*r)*(tmax - tmin)**2 + B26*(L*L)*(l4*l4))/(L*r*((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+0
                        k0v[c] += -i4*j4*k4*l4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*(A12 + A66)/((i4 - k4)*(i4 + k4)*(j4 - l4)*(j4 + l4))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+1
                        k0v[c] += A26*i4*j4*k4*l4*(-2*(-1)**(i4 + k4) + 2)*((-1)**(j4 + l4) - 1)/(((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+3
                        k0v[c] += i4*j4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*((pi*pi)*B26*(L*L)*(l4*l4) + r*(tmax - tmin)**2*(-A45*(L*L) + (pi*pi)*B16*(k4*k4)*r))/((pi*pi)*L*r*((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+4
                        k0v[c] += i4*j4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*((pi*pi)*B22*(L*L)*(l4*l4) + r*(tmax - tmin)**2*(-A44*(L*L) + (pi*pi)*B66*(k4*k4)*r))/((pi*pi)*L*r*((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+2
                        k0v[c] += A45*i4*j4*k4*l4*(-2*(-1)**(i4 + k4) + 2)*((-1)**(j4 + l4) - 1)/(((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+0
                        k0v[c] += -k4*l4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*(B11*(i4*i4)*(r*r)*(tmax - tmin)**2 + B66*(L*L)*(j4*j4))/(L*r*(-(i4*i4) + (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+1
                        k0v[c] += k4*l4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*((pi*pi)*B26*(L*L)*(j4*j4) + r*(tmax - tmin)**2*(-A45*(L*L) + (pi*pi)*B16*(i4*i4)*r))/((pi*pi)*L*r*((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+3
                        ...
                        k0r[c] = row+4
                        k0c[c] = col+0
                        k0v[c] += -k4*l4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*(B16*(i4*i4)*(r*r)*(tmax - tmin)**2 + B26*(L*L)*(j4*j4))/(L*r*(-(i4*i4) + (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+1
                        k0v[c] += k4*l4*((-1)**(i4 + k4) - 1)*((-1)**(j4 + l4) - 1)*((pi*pi)*B22*(L*L)*(j4*j4) + r*(tmax - tmin)**2*(-A44*(L*L) + (pi*pi)*B66*(i4*i4)*r))/((pi*pi)*L*r*((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+3
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+2
                        k0v[c] += A26*L*j4*l4*((-1)**(j4 + l4) - 1)/(r*(j4 + l4)*(2.0*j4 - 2.0*l4))
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+2
                        k0v[c] += L*j4*l4*((-1)**(j4 + l4) - 1)*(A22 + A44)/(r*(j4 + l4)*(2.0*j4 - 2.0*l4))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+0
                        k0v[c] += -A26*L*j4*l4*((-1)**(j4 + l4) - 1)/(r*(j4 + l4)*(2.0*j4 - 2.0*l4))
                        ...
                        k0r[c] = row+2
                        k0c[c] = col+3
                        k0v[c] += i4*j4*((-1)**(j4 + l4) - 1)*(tmax - tmin)*(-A55*r + B12)/((j4 + l4)*(2.0*j4 - 2.0*l4))
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+4
                        k0v[c] += i4*j4*((-1)**(j4 + l4) - 1)*(tmax - tmin)*(-A45*r + B26)/((j4 + l4)*(2.0*j4 - 2.0*l4))
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+2
                        k0v[c] += -i4*l4*((-1)**(j4 + l4) - 1)*(tmax - tmin)*(-A55*r + B12)/((j4 + l4)*(2.0*j4 - 2.0*l4))
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+2
                        k0v[c] += -i4*l4*((-1)**(j4 + l4) - 1)*(tmax - tmin)*(-A45*r + B26)/((j4 + l4)*(2.0*j4 - 2.0*l4))
...
def fk0edges(int m2, int n3, int m4, int n4, double r1, double r2, double L,
    ...
    fdim = 2*(2 + 2*m2 + 2*n3 + 2*m4*n4 + 2*m2*m2 + 2*m2*n3 + 2*m2*m4*n4 +
            2*n3*n3 + 2*n3*m4*n4 + 2*m4*n4*m4*n4)
    ...
    k0edgesr[c] = row+0
    k0edgesc[c] = col+0
    k0edgesv[c] += kphixBot*kphixTop*r1*r2*(tmax - tmin)
    c += 1
    k0edgesr[c] = row+1
    k0edgesc[c] = col+1
    k0edgesv[c] += kphitBot*kphitTop*r1*r2*(tmax - tmin)
    ...
    for k2 in range(1, m2+1):
        ...
        k0edgesr[c] = row+0
        k0edgesc[c] = col+0
        k0edgesv[c] += (-1)**k2*kphixBot*kphixTop*r1*r2*(tmax - tmin)
        c += 1
        k0edgesr[c] = row+1
        k0edgesc[c] = col+1
        k0edgesv[c] += (-1)**k2*kphitBot*kphitTop*r1*r2*(tmax - tmin)
    ...
    for l3 in range(1, n3+1):
        ...
        k0edgesr[c] = row+0
        k0edgesc[c] = col+0
        k0edgesv[c] += 0.5*kphixBot*kphixTop*r1*r2*(tmax - tmin)
        c += 1
        k0edgesr[c] = row+1
        k0edgesc[c] = col+1
        k0edgesv[c] += 0.5*kphitBot*kphitTop*r1*r2*(tmax - tmin)
    ...
    for k4 in range(1, m4+1):
        for l4 in range(1, n4+1):
            ...
            k0edgesr[c] = row+0
            k0edgesc[c] = col+3
            k0edgesv[c] += 0.5*(-1)**k4*kphixBot*kphixTop*r1*r2*(tmax - tmin)
            c += 1
            k0edgesr[c] = row+1
            k0edgesc[c] = col+4
            k0edgesv[c] += 0.5*(-1)**k4*kphitBot*kphitTop*r1*r2*(tmax - tmin)
    ...
    for i2 in range(1, m2+1):
        ...
        for k2 in range(1, m2+1):
            ...
            if k2 == i2:
                ...
                k0edgesr[c] = row+0
                k0edgesc[c] = col+0
                k0edgesv[c] += (-1)**(i2 + k2)*kphixBot*kphixTop*r1*r2*(tmax - tmin)
                c += 1
                k0edgesr[c] = row+1
                k0edgesc[c] = col+1
                k0edgesv[c] += (-1)**(i2 + k2)*kphitBot*kphitTop*r1*r2*(tmax - tmin)
    ...
    for i2 in range(1, m2+1):
        ...
        for l3 in range(1, n3+1):
            ...
            k0edgesr[c] = row+0
            k0edgesc[c] = col+0
            k0edgesv[c] += 0.5*(-1)**i2*kphixBot*kphixTop*r1*r2*(tmax - tmin)
            c += 1
            k0edgesr[c] = row+1
            k0edgesc[c] = col+1
            k0edgesv[c] += 0.5*(-1)**i2*kphitBot*kphitTop*r1*r2*(tmax - tmin)
        ...
        for k4 in range(1, m4+1):
            for l4 in range(1, n4+1):
                ...
                if k4 == i2:
                    ...
                    k0edgesr[c] = row+0
                    k0edgesc[c] = col+3
                    k0edgesv[c] += 0.5*(-1)**(i2 + k4)*kphixBot*kphixTop*r1*r2*(tmax - tmin)
                    c += 1
                    k0edgesr[c] = row+1
                    k0edgesc[c] = col+4
                    k0edgesv[c] += 0.5*(-1)**(i2 + k4)*kphitBot*kphitTop*r1*r2*(tmax - tmin)
    ...
    for j3 in range(1, n3+1):
        ...
        for l3 in range(1, n3+1):
            ...
            if l3 == j3:
                ...
                k0edgesr[c] = row+0
                k0edgesc[c] = col+0
                k0edgesv[c] += 0.375*kphixBot*kphixTop*r1*r2*(tmax - tmin)
                c += 1
                k0edgesr[c] = row+1
                k0edgesc[c] = col+1
                k0edgesv[c] += 0.375*kphitBot*kphitTop*r1*r2*(tmax - tmin)
            else:
                # k0edgesBT_33 cond_2
                c += 1
                k0edgesr[c] = row+0
                k0edgesc[c] = col+0
                k0edgesv[c] += 0.25*kphixBot*kphixTop*r1*r2*(tmax - tmin)
                c += 1
                k0edgesr[c] = row+1
                k0edgesc[c] = col+1
                k0edgesv[c] += 0.25*kphitBot*kphitTop*r1*r2*(tmax - tmin)
        ...
        for k4 in range(1, m4+1):
            for l4 in range(1, n4+1):
                ...
                if l4 == j3:
                    ...
                    k0edgesr[c] = row+0
                    k0edgesc[c] = col+3
                    k0edgesv[c] += 0.375*(-1)**k4*kphixBot*kphixTop*r1*r2*(tmax - tmin)
                    c += 1
                    k0edgesr[c] = row+1
                    k0edgesc[c] = col+4
                    k0edgesv[c] += 0.375*(-1)**k4*kphitBot*kphitTop*r1*r2*(tmax - tmin)
                else:
                    # k0edgesBT_34 cond_2
                    c += 1
                    k0edgesr[c] = row+0
                    k0edgesc[c] = col+3
                    k0edgesv[c] += 0.25*(-1)**k4*kphixBot*kphixTop*r1*r2*(tmax - tmin)
                    c += 1
                    k0edgesr[c] = row+1
                    k0edgesc[c] = col+4
                    k0edgesv[c] += 0.25*(-1)**k4*kphitBot*kphitTop*r1*r2*(tmax - tmin)
            ...
            for k4 in range(1, m4+1):
                for l4 in range(1, n4+1):
                    ...
                    if k4 == i4 and l4 == j4:
                        ...
                        k0edgesr[c] = row+3
                        k0edgesc[c] = col+3
                        k0edgesv[c] += 0.375*(-1)**(i4 + k4)*kphixBot*kphixTop*r1*r2*(tmax - tmin)
                        c += 1
                        k0edgesr[c] = row+4
                        k0edgesc[c] = col+4
                        k0edgesv[c] += 0.375*(-1)**(i4 + k4)*kphitBot*kphitTop*r1*r2*(tmax - tmin)
                        ...
                        k0edgesr[c] = row+3
                        k0edgesc[c] = col+3
                        k0edgesv[c] += 0.25*(-1)**(i4 + k4)*kphixBot*kphixTop*r1*r2*(tmax - tmin)
                        c += 1
                        k0edgesr[c] = row+4
                        k0edgesc[c] = col+4
                        k0edgesv[c] += 0.25*(-1)**(i4 + k4)*kphitBot*kphitTop*r1*r2*(tmax - tmin)
            ...
            for k4 in range(1, m4+1):
                for l4 in range(1, n4+1):
                    ...
                    if k4 == i4 and l4 == j4:
                        ...
                        kG0r[c] = row+2
                        kG0c[c] = col+2
                        kG0v[c] += i4*j4*k4*l4*(-2*(-1)**(i4 + k4) + 2)*((-1)**(j4 + l4) - 1)*(Ftx*r*(tmax - tmin) + Fxt*L)/(L*r*((i4*i4) - (k4*k4))*(j4 - l4)*(j4 + l4)*(tmax - tmin))
                    elif k4 == i4 and l4 != j4:
                        # kG0_44 cond_4
                        pass
