            ...
            for k1 in range(1, m1+1):
                for l1 in range(1, n1+1):
                    ...
                    if k1 != i1 and l1 != j1:
                        ...
                        kG0r[c] = row+2
                        kG0c[c] = col+3
                        kG0v[c] += i1*j1*((-1)**(i1 + k1) - 1)*((-1)**(j1 + l1) - 1)*(Nxx*(b*b)*(k1*k1) + Nyy*(a*a)*(l1*l1))/(a*b*((i1*i1) - (k1*k1))*((j1*j1) - (l1*l1)))
                        c += 1
                        kG0r[c] = row+3
                        kG0c[c] = col+2
                        kG0v[c] += k1*l1*((-1)**(i1 + k1) - 1)*((-1)**(j1 + l1) - 1)*(Nxx*(b*b)*(i1*i1) + Nyy*(a*a)*(j1*j1))/(a*b*((i1*i1) - (k1*k1))*((j1*j1) - (l1*l1)))
                        c += 1
                        kG0r[c] = row+3
                        kG0c[c] = col+3
                        kG0v[c] += -Nxy*((-1)**(i1 + k1) - 1)*((-1)**(j1 + l1) - 1)*((i1*i1)*(l1*l1) + (j1*j1)*(k1*k1))/((i1 - k1)*(i1 + k1)*(j1 - l1)*(j1 + l1))
