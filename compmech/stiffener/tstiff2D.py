...
class TStiff2D(object):
    ...
    def calc_k0(self, size=None, row0=0, col0=0, silent=False, finalize=True):
        ...
        k0 += conn.fkCpbx1x2y1y2(0, x1, y1, y2,
                                 ...
                                 v1ty, v1ry, v2ty, v2ry,
                                 w1ty, w1ry, w2ty, w2ry,
                                 u1txb, u1rxb, u2txb, u2rxb,
                                 v1txb, v1rxb, v2txb, v2rxb,
                                 w1txb, w1rxb, w2txb, w2rxb,
                                 u1tyb, u1ryb, u2tyb, u2ryb,
                                 v1tyb, v1ryb, v2tyb, v2ryb,
                                 w1tyb, w1ryb, w2tyb, w2ryb,
                                 size, 0, col0)
        ...
        k0 += conn.fkCbf(kt, kr, a, bb, bf,
                         ...
                         v1tyb, v1ryb, v2tyb, v2ryb,
                         w1tyb, w1ryb, w2tyb, w2ryb,
                         u1txf, u1rxf, u2txf, u2rxf,
                         v1txf, v1rxf, v2txf, v2rxf,
                         w1txf, w1rxf, w2txf, w2rxf,
                         u1tyf, u1ryf, u2tyf, u2ryf,
                         v1tyf, v1ryf, v2tyf, v2ryf,
                         w1tyf, w1ryf, w2tyf, w2ryf,
                         size, row0, col1)
