...
#                   'Compmech Documentation',
#                    'Compmech Development Team', 'manual', True)]
...
texinfo_documents = [
    (master_doc, 'CompMech', 'CompMech Documentation',
                 'Compmech Development Team',
   'CompMech', 'Computational Mechanics in Python', 'Programming', 1),
]
